...
lines <- st_read("./Data/1913/trolley.shp")
...
plot7 <- ggplot() +
  ...
  geom_sf_text(data = termini, aes(label = Name), color = "black", size = 2.5, family = "Old Standard TT", fontface = "italic", vjust = 1.5) +
  ggtext::geom_textbox(
    ...
    width = unit(3, "in"), # Adjust the width as needed
    halign = 0.5, valign = 0.5, lineheight = 1.2
  ) +
  ggtext::geom_textbox(
    aes(x = 103.872369, y = 1.277, 
        label = "THE FINEST RIDES IN THE EMPIRE"), 
